...
dataset="" ## Preference Dataset to train Research-Question-Focused Query Optimizer Agents
output_dir="Trained_Models/${dataset}/${model_name}/${agent_name}"
bits=4
report_to="wandb"
save_strategy="steps"
save_steps=10000
project_name="DPO_${agent_name}_Llama_3_2_3B_Instruct_BGE_M3_ground_truth_reference_decentralized_reward_top_30_for_Iterative_Retrieval"
learning_rate=1e-5
weight_decay=0.01
max_grad_norm=0.6
logging_steps=10
