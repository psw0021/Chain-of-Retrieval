...
use_gpt=True
benchmark_directory="LongDocumentBench/Patents/Patent_Benchmark/Benchmark/Direct_References"
embedding_model="pat_specter"
top_k=300
max_top_k=300
use_RRF_for_chunked_baseline=False
hyperparameter_RRF=60
corpus_directory="LongDocumentBench/Patents/Patent_Benchmark/Target_Corpus/target_corpus_final_sanitized_3000/corpus.json"
batch_size=1
